...
var XpiInstaller = {
	...
	extFullName: 'RndPhrase', // The name displayed to the user (don't include the version)
	extShortName: 'rndphrase', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Johan Brinch',
