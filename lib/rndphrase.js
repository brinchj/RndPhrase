...
var RndPhrase = {
    ...
    hash_seed : function(){ function(passwd, host) {
            return RndPhrase.hash("", passwd, host); }; // empty seed
    },
    pack : function(msg) {
    ...
    self_test : function() {
        ...
        var prng_hashs = new Array("s57obudc63xa2pzj");
    ...
    update_input : function(host, mods, I) {
        return function(e) {
            if(I.value[0] == '@')
                I.value = mods(RndPhrase.hash_seed(I.value.substring(1), host));
        };
    },
