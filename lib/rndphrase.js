...
// Set namespace
namespace("com.rndphrase.RndPhrase", this);
// Is this macro really neccessary to reference com.rndphrase.RndPhrase inside closures?
#define RNDPHRASE com.rndphrase.RndPhrase

com.rndphrase.RndPhrase = {
    ...
    hash : function(msg) {
        return com.rndphrase.CubeHash.hash(msg);
    },
    // generate :: (String, String, String) -> String[16]
    generate : function(seed, passwd, host) {
    ...
    set_seed_hash : function(seed_hash) {
        ...
        RNDPHRASE.hash_seed = function(passwd, host) {
            return RNDPHRASE.generate(seed_hash, passwd, host); };
    },
    ...
    // self_test :: () -> Bool
    self_test : function() {
        if(!com.rndphrase.CubeHash.self_test()) {
            return false;
        }
        ...
        while(prng_tests.length > 0) {
            ...
            if(RNDPHRASE.generate(_seed, passwd, host) != prng_hashs.pop()) {
                return false;
            }
        }
        return true;
