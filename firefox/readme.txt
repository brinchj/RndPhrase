...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\rndphrase on
     Windows, /home/user/dev/rndphrase on Linux) in a file named
     rndphrase@firefox and copy that file to
